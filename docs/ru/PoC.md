...
**Связанные документы:** [Видение и дорожная карта](VISION_AND_ROADMAP.md) · [План реализации](plan.md) · [Модель доверия](TRUST_MODEL.md) · [Диаграммы архитектуры](../../diagrams/architecture.md)
...
1. [Диаграммы архитектуры](../../diagrams/architecture.md) (Mermaid: пайплайн, цепочка доверия)
2. README PoC как GitHub project
3. Пример RFC 3161 timestamp flow
4. Пример BouncyCastle timestamp verification
5. [Видение и дорожная карта](VISION_AND_ROADMAP.md) — PoC → demo → EU-style product
