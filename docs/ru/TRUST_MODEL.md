...
Документ описывает модель доверия PoC Aletheia: криптографическую цепочку, кто удостоверяет содержание и время, и соответствие текущей (неквалифицированной) настройки будущей квалифицированной (eIDAS). Подробности: [Подпись](SIGNING.md), [Временные метки](TIMESTAMPING.md).
...
- [Видение и дорожная карта](VISION_AND_ROADMAP.md) — следующие шаги: AI Claim, офлайн-верификация, модель ключей, evidence package.
