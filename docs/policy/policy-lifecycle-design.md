...
**Related:** [Phase 4→5 transition](../internal/en/phase4-5-transition.md) §3.1 · [Demo policy (2026-01)](aletheia-demo-2026-01.md) · [Policy creation and human verification](policy-creation-and-human-verification.md)
...
- **Authoritative definitions:** Policy files (JSON + optional MD) live in a versioned location. Today: `docs/policy/` (e.g. `aletheia-demo-2026-01.json`, `aletheia-demo-2026-01.md`). Phase 5 could keep this for “baked-in” policies and add an **internal registry** (DB or config service) that maps `(policy_id, policy_version)` to the rule set (or to a path/URL).
...
| Storage | Versioned files (e.g. `docs/policy/`) plus optional internal registry for Phase 5. |
