...
**Koodi juhend (LLM-readable):** vt [docs/internal/en/plan.md](../en/PLAN.md#task-235--crypto-demo-endpoint-bridge-to-api).
...
**Millal rakendada:** Kui on 3+ REST endpoint'i või pärast Sammu 5. Üksikasjad ja LLM-readable prompt: vt [docs/internal/en/plan.md](../en/PLAN.md#task-73--swagger--openapi-implement-when-needed).
