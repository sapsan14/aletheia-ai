...
Определить и задокументировать минимальный .aep: response.txt, canonical.bin, hash.sha256, signature.sig, timestamp.tsr, metadata.json, public_key.pem. Документировать в README или docs/internal/en/plan-phase2.md. Критерий приёмки: все семь компонентов перечислены.
...
В README: разделы «Evidence Package & offline verification», «Killer demo (Phase 2)», «Works with MCP / OpenClaw / any agent»; ссылки на [Plan Phase 2](internal/en/plan-phase2.md), [Demo script](../../scripts/demo-script.md), Vision Phase 2. В docs/README: Plan Phase 2 | [EN](internal/en/plan-phase2.md) · [RU](internal/ru/plan-phase2.md) · [ET](internal/et/plan-phase2.md).
