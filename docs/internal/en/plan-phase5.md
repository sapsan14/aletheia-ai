...
- [ ] **Integrations (5.5)**  
  SIEM / blockchain exports are documented in `docs/internal/en/`, but not wired as production integrations.
...
- Documentation: `docs/internal/en/attestation.md` describing the flow and metadata.
...
- Create directory `docs/internal/en/` if it does not exist. Create file `docs/internal/en/attestation.md`.
...
- Update docs/internal/en/attestation.md: "Supported in API: pass agentId and toolUsage in POST /api/sign; they appear in GET /api/ai/verify/:id and in Evidence Package metadata."
...
| 6 | MCP attestation documented (docs/internal/en/attestation.md) | [ ] |
