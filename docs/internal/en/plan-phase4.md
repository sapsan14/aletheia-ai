...
- [x] **A.1 Demo policy**  
  `docs/policy/aletheia-demo-2026-01.json` and `.md` exist and are used as the canonical demo policy (rules R1–R4).
...
- File `docs/policy/aletheia-demo-2026-01.json` (or `.yaml`) defining the demo policy.
...
- Documentation: `docs/policy/aletheia-demo-2026-01.md`.
...
- Create directory `docs/policy/` if it does not exist.
- Create file `docs/policy/aletheia-demo-2026-01.json` with the following structure (adapt keys to your preferred style; this is a minimal example):
...
- Create file `docs/policy/aletheia-demo-2026-01.md` that describes: (1) purpose of this policy; (2) what each rule means; (3) that R3 and R4 are `not_evaluated` in Phase 4 and why (honest transparency). Use short paragraphs and a table listing rule id, description, check status.
