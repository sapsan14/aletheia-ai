...
**Internal** — For project planning only. Not for external distribution.
...
**Concrete plan:** Step-by-step tasks (Evidence Package, offline verifier, one killer demo scenario, LLM-readable coding prompts) are in [Plan Phase 2](plan-phase2.md). Run the demo in ≤5 min: [Demo script](../../scripts/demo-script.md). Plan Phase 2 also describes [opportunities](plan-phase2.md#opportunities-why-this-direction) (market, niche, differentiator) in plain language.
