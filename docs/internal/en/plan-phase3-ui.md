...
**Related:** [Plan Phase 2](plan-phase2.md) (Evidence Package, killer demo) · [Demo script](../../scripts/demo-script.md) · [Vision Phase 2](vision-roadmap.md#2-killer-demo--domain-choice)
...
- [Demo script](../../scripts/demo-script.md) — Step-by-step demo flow.
