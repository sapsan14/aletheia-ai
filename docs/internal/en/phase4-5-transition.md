...
- [x] **Demo policy is finalized**
  - `docs/policy/aletheia-demo-2026-01.json` and `.md` exist and are considered canonical.
...
- Update `docs/policy/aletheia-demo-2026-01.md`:
...
> - Describe how policy files are stored and versioned (e.g. `docs/policy/` plus an internal registry).
...
Place this design in a new doc, e.g. `docs/policy/POLICY_LIFECYCLE_DESIGN.md`.
...
- Top of `README.md`.
- Top of `docs/internal/en/plan-phase5.md`.
...
> In `docs/internal/en/plan-phase5.md` or `docs/internal/en/plan-phase5.md`, draft a short section describing:
...
- “Integrate in your stack” link to docs/internal/en/plan-phase5 or an integrations section.
...
Use the [Manual test checklist (4.2)](../../scripts/manual-test-checklist-4-2.md) to run and sign off.
