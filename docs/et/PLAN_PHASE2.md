...
Defineerida ja dokumenteerida minimaalne .aep: response.txt, canonical.bin, hash.sha256, signature.sig, timestamp.tsr, metadata.json, public_key.pem. Dokumenteerida README-s või docs/en/PLAN_PHASE2.md. Vastuvõtu kriteerium: kõik seitse komponenti loetletud.
...
README-s: jaotised «Evidence Package & offline verification», «Killer demo (Phase 2)», «Works with MCP / OpenClaw / any agent»; lingid [Plan Phase 2](docs/en/PLAN_PHASE2.md), DEMO_SCRIPT, Vision Phase 2. docs/README tabelis: Plan Phase 2 | [EN](en/PLAN_PHASE2.md) · [RU](ru/PLAN_PHASE2.md) · [ET](et/PLAN_PHASE2.md).
