...
| EDU.1.3 | Luua docs/et/EDU_README.md (valikuline) | Lühike indeks: mida lugeda üliõpilasel/õppejõul (PoC, PLAN_PQC, Usaldusmudel, Legal), kuidas lab käivitada. |
...
2) Linkide nimekiri: docs/et/PLAN_EDU.md (haridusplatvormi plaan), docs/en/PLAN_PQC.md (postkvantkrüptograafia), docs/legal/README.md (normatiivsed ja PQC dokumendid) ning vajadusel viide laboristsenaariumidele docs-is. 
...
```
Loo uus fail docs/et/LAB_CLASSICAL_CHAIN.md. 
Sisu eesti keeles. 
...
```
Loo fail docs/et/LAB_HYBRID_PQC.md eesti keeles. 
...
5) Viited docs/en/PLAN_PQC.md ja docs/legal/README.md (PQC sektsioon). 
...
```
Loo docs/et/LAB_BREAK_CHAIN.md eesti keeles. 
...
3) Viide docs/et/PLAN_EDU.md ja laboristsenaariumidele docs/et/LAB_*.md kui need on olemas. 
...
- [ ] Vähemalt üks laboristsenaarium (LAB_CLASSICAL_CHAIN või LAB_HYBRID_PQC) docs/et/ Mermaidiga ja samm-sammuliste juhenditega.
...
**Tõlked:** Plaan EDU on olemas eesti (see fail), vene ([docs/ru/PLAN_EDU.md](../ru/PLAN_EDU.md)) ja vajadusel inglise keeles.
